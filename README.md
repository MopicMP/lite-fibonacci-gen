...
> Lite fibonacci sequence generator with memoization

[![PyPI version](https://badge.fury.io/py/lite-fibonacci-gen.svg)](https://pypi.org/project/lite-fibonacci-gen/)
...
```bash
pip install lite-fibonacci-gen
```

## Quick Start

```python
from lite_fibonacci_gen import gen
...
from lite_fibonacci_gen import batch
